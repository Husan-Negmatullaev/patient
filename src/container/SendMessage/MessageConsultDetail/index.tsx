...
import ConsultQuestionDetail from "components/ConsultQuestionDetail";
...
const BookAppointmentDetail = memo(() => {
  ...
  const onPayment = () => {
    navigate(Routes.MessagePayment);
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <SubtitleItem icon="help" title="What is your question?">
          <ConsultQuestionDetail
            attachment={attachment}
            question={question}
            onOpenAttachmentModal={attachOpen}
